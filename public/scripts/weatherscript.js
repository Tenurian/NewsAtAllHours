...
//    document.body.style.backgroundImage = "url('images/"+papername+".jpg')"
    var date = new Date(),
        i;
...
//        imgdiv.getElementsByClassName("imagine")[0].style.width = "99%";
//        imgdiv.getElementsByClassName("imagine")[0].style.height = "auto";
//        imgdiv.style.margin = "0px, auto";
//        $(document.getElementById(daydiv).getElementsByClassName("info")[0]).slideUp();
